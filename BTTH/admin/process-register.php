    ...
    if (empty($errors)) {
        ...
        if(mysqli_num_rows($result)>0){
            ...
            if(mysqli_query($conn, $sql)){
                ...
                $noidungthu = "Bạn đã đăng kí tài khoản tại Lê Minh, để sử dụng tài khoản, vui lòng nhấp vào liên kết
                ...
                $from = "ltnminh12ahla@gmail.com";
            
                //pass email gmail
                $p = "0968048630"; //thay_mat_khau_cua_ban_vao_day
                $m -> sendMailFromLocalhost($to, $from, $tennguoigui="Lê Minh", $tieudethu, $noidungthu, $from, $p, $error);
                header("Location: admin/register-page-successfully.php");
                exit();
            }else{
