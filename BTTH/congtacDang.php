                        ...
                        <ul class="related-list" style="list-style:none; margin-bottom:50px;">
                            ...
                            <li style="display: block; border-bottom: 1px solid #ccc; padding: 7px 7px; padding: 25px 0;">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9" style="text-align:justify">
                                        <h4 class="related-title"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">Dự thảo các văn kiện Đại hội XIII của Đảng để lấy ý kiến Nhân dân</a></h4>
                            ...
                            <li style="display: block; border-bottom: 1px solid #ccc; padding: 7px 7px; padding: 25px 0;">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <figure>
                                            <a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">
                                                <img src="Images/cong-van-so-245-quan-ly-van-ban-di-den.jpg" alt="">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="col-sm-9" style="text-align:justify">
                                        <h4 class="related-title"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">Văn bản của Đảng ủy trường</a></h4>
                                        <p class="time-post">15/09/2018 00:00</p>
                                        <p class="text-right font-16px"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876"><i class="fa fa-angle-right"></i><em>Xem chi tiết</em></a></p>
                                    </div>
                                </div>
                            ...
                            <li style="display: block; border-bottom: 1px solid #ccc; padding: 7px 7px; padding: 25px 0;">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <figure>
                                            <a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">
                                                <img src="Images/DaiHoiDang26.jpg" alt="">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="col-sm-9" style="text-align:justify">
                                        <h4 class="related-title"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">Đại hội Đảng bộ Trường Đại học Thủy Lợi lần thứ XXVI – Phiên chính thức.</a></h4>
                                        <p class="time-post">12/12/2011 00:00</p>
                                        <p>Sáng nay ngày 22/12/2011 tại Hội trường T45, Đại hội Đảng bộ Trường Đại học Thủy Lợi lần thứ XXVI chính thức được diễn ra.</p>
                                        <p class="text-right font-16px"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876"><i class="fa fa-angle-right"></i><em>Xem chi tiết</em></a></p>
                                    </div>
                                </div>
                            </li>
                            <li style="display: block; border-bottom: 1px solid #ccc; padding: 0px 25px; height:130px;">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9" style="text-align:justify">
                                        <h4 class="related-title"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">Đại hội Đảng bộ Trường Đại học Thủy Lợi lần thứ XXVI Phiên trù bị.</a></h4>
                                        <p class="time-post">12/12/2011 00:00</p>
                                        <p>Đại hội Đảng bộ Trường Đại học Thủy Lợi lần thứ XVI sẽ diễn ra các ngày 21&22/12/2011. Chiều nay ngày 21/12/2011 tại Hội trường T45 đã diễn ra phiên họp trù bị Đại hội Đảng bộ trường Đại học Thủy Lợi lần thứ XVI.</p>
                                        <p class="text-right font-16px"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876"><i class="fa fa-angle-right"></i><em>Xem chi tiết</em></a></p>
                                    </div>
                                </div>
                            </li>
                            <li style="display: block; border-bottom: 1px solid #ccc; padding: 0px 25px; height:130px;">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9" style="text-align:justify">
                                        <h4 class="related-title"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">Đại hội Đảng bộ Trường Đại học Thủy lợi lần thứ XXV</a></h4>
                                        <p class="time-post">12/12/2011 00:00</p>
                                        <p>Lần đầu tiên trong Đại hội Đảng bộ đã chọn chủ đề làm định hướng chung cho các mục tiêu phấn đấu trong nhiệm kỳ. Chủ đề của Đại hội lần thứ XXV là: Tăng cường đoàn kết, phát huy trí tuệ, năng động và tiếp tục đổi mới thực hiện thắng lợi giai đoạn chuyển đổi chiến lược phát triển Trường Đại học Thuỷ lợi.</p>
                                        <p class="text-right font-16px"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876"><i class="fa fa-angle-right"></i><em>Xem chi tiết</em></a></p>
                                    </div>
                                </div>
                            </li>
                            <li style="display: block; border-bottom: 1px solid #ccc; padding: 0px 25px; height:130px;">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9" style="text-align:justify">
                                        <h4 class="related-title"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876">Đại hội Đảng bộ Trường Đại học Thủy lợi lần thứ XXIV</a></h4>
                                        <p class="time-post">12/12/2011 00:00</p>
                                        <p>Thực hiện Chiến lược phát triển của Nhà trường giai đoạn 2006-2020, Đảng ủy đang chỉ đạo triển khai Dự án mở rộng Trường tại Chương Mỹ trên diện tích đất 57 ha. Trường đã tổ chức thi thiết kế quy hoạch tổng thể để lựa chọn phương án hợp lý... Toàn trường đã bước đầu thực hiện điều hành công việc qua mạng và trang Website với nội dung ngày càng tốt hơn.</p>
                                        <p class="text-right font-16px"><a href="http://www.tlu.edu.vn/cong-tac-dang/danh-sach-bch-dang-bo-truong-nhiem-ky-9876"><i class="fa fa-angle-right"></i><em>Xem chi tiết</em></a></p>
                                    </div>
                                </div>
                            </li>
